...
<%-- wsList1内の年を取得 --%>
<%
WorkScheduleEntity wsEntity = wsList.get(0);
Date date = wsEntity.getDate();
...
<form action="/Java_Architect_Spring/scheduleInput" method="post">
...
<%
for(WorkScheduleEntity ws : wsList){
	//日にちの格納
	date = ws.getDate();
